...
| [ADR-11](../adr-11-opa-odrl-enforcement.md) | ODRL-Constraints werden auf eingebettetem OPA evaluiert. Supersedet den Evaluator-Mechanismus aus ADR-6, dessen Enforcement-Entscheidung unverändert steht. |
